...
def create_daily_report(with_db_update=False):
    ...
    a_period={"Market":[(0,9999999)],"I":[(1200,9999999)],"FD":[(600,800),(800,1200),(1200,9999999)],"E":[(600,800),(800,1200),(1200,9999999)]}
    top={"I":0.10,"FD":0.12,"E":0.04}
    tail = 500
    ...
    #read bullishness
    xls = pd.ExcelFile(f"Market/CN/ATest/bullishness/bullishness_CN_0_{trade_date}.xlsx")
            ...
            for ts_code,df_asset in d_preload_E.items():
                ...
                if asset == "E":
                    for column in ["pe_ttm", "pb"]:
                        ...
                        df_selected_assets.at[ts_code, f"{column}_NOW"] = df_helper[f"{column}"].iat[-1]
...
if __name__ == '__main__':
    ...
    create_daily_report(with_db_update=False)
